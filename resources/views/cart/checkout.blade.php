...
<div class="container">
    ...
    <div class="breadcrumb">
        <li>
            <a href="{{ URL::to('home') }}"><i class="fa fa-home"></i> หน้าร้าน  </a>
        </li>
        <li>
            <a href="{{ URL::to('cart/view') }}"> สินค้าในตะกร้า  </a>
        </li>
            ...
            <table class="table bs-table">
                <thead>
                    <tr>
                        ...
                        <th> ชื่อสินค้า </th>
                        <th> จำนวน </th>
                        <th class="bs-price"> ราคาต่อชิ้น </th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{ asset($c['image_url'],0) }}" width="50px" hight="50px"></td>
                        <td> {{ $c['code'] }} </td>
                        <td> {{ $c['name'] }} </td>
                        <td> {{ number_format($c['qty'],0) }} </td>
                        <td class="bs-price"> {{ number_format($c['price'],2) }} </td>
    ...
    <div class="pull-right">
        ...
        <a href="javascript:complete()" class="btn btn-primary"><i class="fa fa-check"></i> จบการขาย </a>
            <script type="text/javascript">
                ...
                {
                    window.open(
                    "{{ URL::to('cart/complete') }}?cust_name="+ $('#cust_name').val() + 
